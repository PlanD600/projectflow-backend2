...
CREATE TABLE "ProjectTeamLead" (
    ...
    CONSTRAINT "ProjectTeamLead_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectTeamLead_projectId_userId_key" ON "ProjectTeamLead"("projectId", "userId");
...
-- AddForeignKey
ALTER TABLE "ProjectTeamLead" ADD CONSTRAINT "ProjectTeamLead_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectTeamLead" ADD CONSTRAINT "ProjectTeamLead_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
